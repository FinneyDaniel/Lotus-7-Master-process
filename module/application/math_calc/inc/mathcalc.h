...
#define MATH_mDPTGAIN                    (8.125f)
#define MATH_mDPTOFFSET                  (110.0f)
...
typedef struct MATHCONV_zREGS
{
    ...
    float32_t AISensorDPT401;

    float32_t AISensorPRT402;
    float32_t AISensorPRT403;
    float32_t AISensorPRT404;
    float32_t AISensorPRT405;
    float32_t AISensorPRT406;
    float32_t AISensorPRT407;
    float32_t AISensorRTD401;
    float32_t AISensorRTD402;
    float32_t AISensorRTD403;
    float32_t AISensorRTD404;
    float32_t AISensorMFM401;
    float32_t AISensorMFM402;
}MATHCONV_tzREGS;
